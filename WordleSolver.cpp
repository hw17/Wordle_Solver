...
#include <vector> // for data structure manipulation
#include <string>
#include <algorithm>
#include <sstream> // for parsing and formating strings
#include <iterator> // use iterators for traversing

class WordleSolver
{
/*
 * ignoreWords: A vector that will hold any letters the user wishes to ignore 
 * when searching for potential words.
 * board: This vector represents the board state, showing which letters are 
 * known and where there are gaps.
 */
private:
    /* data */
...
public:
    ...
    // required letters
    void play_test_requiredLetters() { 
        std::string prompt = "Your current cell is marked with a '='.\n * Enter a letter if you know it belongs in that cell.\n * Enter a space if you want to skip to the next cell.\n * Enter '1' to move one cell back and make changes.\n * Enter '0' to exit the board editing process.";
        std::cout << prompt << std::endl;
